        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetPerWeek = table.Column<int>(type: "integer", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    HabitTaskId = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskCompletions_Tasks_HabitTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskSchedules_Tasks_HabitTaskId",
                        column: x => x.HabitTaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserTaskStreaks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserTaskStreaks_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserTaskStreaks_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_XPEvents_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_XPEvents_TaskCompletions_TaskCompletionId",
            ...
            migrationBuilder.CreateIndex(
                ...
                columns: new[] { "HabitTaskId", "CompletionDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskCompletions_HabitTaskId_UserId_CompletionDate",
                table: "TaskCompletions",
                columns: new[] { "HabitTaskId", "UserId", "CompletionDate" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskSchedules_HabitTaskId_DayOfWeek",
                table: "TaskSchedules",
                columns: new[] { "HabitTaskId", "DayOfWeek" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTaskStreaks_TaskId",
                table: "UserTaskStreaks",
                column: "TaskId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserTaskStreaks_TaskId_UserId",
                table: "UserTaskStreaks",
                columns: new[] { "TaskId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserTaskStreaks_User",
                table: "UserTaskStreaks",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_XPEvents_Category",
                table: "XPEvents",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_XPEvents_TaskCompletionId",
                table: "XPEvents",
                column: "TaskCompletionId");

            migrationBuilder.CreateIndex(
                name: "IX_XPEvents_User",
                table: "XPEvents",
                column: "UserId");
        }
